"""Project Euler: Problem Problem 8: Largest product in a series
...
def largestProductinaSeries(n):
    thousandDigits = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9, 2, 2, 5, 1, 1, 9, 6, 7, 4, 4, 2, 6, 5,
...
Test.assert_equals(largestProductinaSeries(4), 5832)
Test.assert_equals(largestProductinaSeries(13), 23514624000)
